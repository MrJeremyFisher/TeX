...
respectively (see \ref{plotter-code} for calculation). The likely highest influence on this is again the non-rigidity of the experiment and
light leakage from surrounding sources, methods to improve which
\section{Conclusion}
