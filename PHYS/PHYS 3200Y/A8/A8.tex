    ...
    \item The magnetic field due to a dipole is given by
          ...
          \begin{align*}
            \bv{B}(\bv{r}) & =\frac{\mu_0 \sigma \omega }{2}\left[\frac{R^2+2z^2}{\sqrt{R^2+z^2}}-2z\right]\uz                                                                                                                                                                                      \\
                           ...
                           & \approx \frac{\mu_0 \sigma \omega }{2}\left[\frac{1}{z}\left[R^2+2z^2\right]\left[1-\frac{1}{2}\left(\frac{R}{z}\right)^2+\frac{3}{8}\left(\frac{R}{z}\right)^4\right]-2z\right]\uz                                                                                    \\
                           & =\frac{\mu_0 \sigma \omega }{2}\left[\frac{1}{z}\left[R^2\left[1-\frac{1}{2}\left(\frac{R}{z}\right)^2+\frac{3}{8}\left(\frac{R}{z}\right)^4\right]+2z^2\left[1-\frac{1}{2}\left(\frac{R}{z}\right)^2+\frac{3}{8}\left(\frac{R}{z}\right)^4\right]\right]-2z\right]\uz \\
                           & =\frac{\mu_0 \sigma \omega }{2}\left[\frac{1}{z}\left[R^2-\frac{R^2}{2}\left(\frac{R}{z}\right)^2+\frac{3R^2}{8}\left(\frac{R}{z}\right)^4+2z^2-\frac{2z^2}{2}\left(\frac{R}{z}\right)^2+\frac{6z^2}{8}\left(\frac{R}{z}\right)^4\right]-2z\right]\uz                  \\
                           & =\frac{\mu_0 \sigma \omega }{2}\left[\frac{R^2}{z}-\frac{R^2}{2z}\left(\frac{R}{z}\right)^2+\frac{3R^2}{8z}\left(\frac{R}{z}\right)^4+2z-z\left(\frac{R}{z}\right)^2+\frac{3z}{4}\left(\frac{R}{z}\right)^4-2z\right]\uz                                               \\
                           & =\frac{\mu_0 \sigma \omega }{2}\left[\frac{R^2}{z}-\frac{R^2}{2z}\left(\frac{R}{z}\right)^2+\frac{3R^2}{8z}\left(\frac{R}{z}\right)^4-z\left(\frac{R}{z}\right)^2+\frac{3z}{4}\left(\frac{R}{z}\right)^4\right]\uz                                                     \\
                           & =\frac{\mu_0 \sigma \omega }{2}\left[\frac{R^2}{z}-\frac{R^4}{2z^3}+\frac{3R^6}{8z^5}-\frac{R^2}{z}+\frac{3R^4}{4z^3}\right]\uz                                                                                                                                        \\
                           & =\frac{\mu_0 \sigma \omega }{2}\left[-\frac{2R^4}{4z^3}+\frac{3R^6}{8z^5}+\frac{3R^4}{4z^3}\right]\uz                                                                                                                                                                  \\
                           & \approx\frac{\mu_0 \sigma \omega }{2}\left[\frac{R^4}{4z^3}\right]\uz
          \end{align*}
  \end{enumerate}
\end{soln}
...
\begin{soln}
  ...
  Since $\bv{c}$ is arbitrary (aside from being constant) we obtain the desired result. The rest of the derivation follows.
\end{soln}
...
\begin{soln}
  ...
  This will want to rotate the magnetic moment of the loop to align with $\bv{B}$ (so that the cross product in $\bv{\tau}$ is zero) so it will come to rest when the moment is facing in $-\uz$.
\end{soln}
