...
\begin{soln}
  \begin{enumerate}[label=(\alph*)]
    \item To do this we first need to include time-dependence in $\ket{\alpha}$. This will come from
          a time evolution operator of the form $\exp(-i\hat{H}t/\hbar)$ since we know
          $\ket{n}$ has energy $E_n=\hbar\omega(n+1/2)$ this operator becomes
          $e^{-i\omega(n+1/2)t}$ and we get that
