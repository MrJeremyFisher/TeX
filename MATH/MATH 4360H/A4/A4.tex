...
\begin{soln}
  ...
  $$[\mathbb{Q}(\sqrt[3]{2},\sqrt[3]{6},\sqrt[3]{24}):\mathbb{Q}]
    =[\mathbb{Q}(\sqrt[3]{2})(\sqrt[3]{6})(\sqrt[3]{24}):\mathbb{Q}]
    =[\mathbb{Q}(\sqrt[3]{2})(\sqrt[3]{6})(\sqrt[3]{24}):\mathbb{Q}(\sqrt[3]{2})(\sqrt[3]{6})][\mathbb{Q}(\sqrt[3]{2})(\sqrt[3]{6}):\mathbb{Q}(\sqrt[3]{2})][\mathbb{Q}(\sqrt[3]{2}):\mathbb{Q}]$$
  We can quickly see that $[\mathbb{Q}(\sqrt[3]{2})(\sqrt[3]{6})(\sqrt[3]{24}):\mathbb{Q}(\sqrt[3]{2})(\sqrt[3]{6})]=1$ as
  $\sqrt[3]{24}=(\sqrt[3]{2})^2\sqrt[3]{6}$ and so $\sqrt[3]{24}$ has minimal polynomial $x-(\sqrt[3]{2})^2\sqrt[3]{6}$ over $\mathbb{Q}(\sqrt[3]{2})(\sqrt[3]{6})$. We can also see that
  $[\mathbb{Q}(\sqrt[3]{2}):\mathbb{Q}]=3$ as $\mathbb{Q}(\sqrt[3]{2})$ has minimal polynomial $x^3-2$ (irreducible by Eisenstein, $p=2$) over $\mathbb{Q}$. So
  $$[\mathbb{Q}(\sqrt[3]{2},\sqrt[3]{6},\sqrt[3]{24}):\mathbb{Q}]
    =3[\mathbb{Q}(\sqrt[3]{2})(\sqrt[3]{6}):\mathbb{Q}(\sqrt[3]{2})].$$
  Now $\mathbb{Q}(\sqrt[3]{2})(\sqrt[3]{6})=\mathbb{Q}(\sqrt[3]{2})(\sqrt[3]{2}\sqrt[3]{3})=\mathbb{Q}(\sqrt[3]{2})(\sqrt[3]{3})$ which, over
  $\mathbb{Q}(\sqrt[3]{2})$, has minimal polynomial $x^3-3$. This means the total degree is $3\cdot3=9$.
\end{soln}
